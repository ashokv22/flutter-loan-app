              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    TextInput(label: "First Name", controller: firstName, onChanged: (newValue) {}, isEditable: true, isReadable: false,),
                    const SizedBox(height: 20),
                    TextInput(label: "Middle Name", controller: middleName, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    TextInput(label: "Last Name", controller: lastName, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    TextInput(label: "Father's First Name", controller: fathersFn, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    TextInput(label: "Father's Middle Name", controller: fathersMn, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    TextInput(label: "Father's Last Name", controller: fathersLn, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    Row(
                      children: [
                    ...
                    const SizedBox(height: 20),
                    TextInput(label: "Address Line 2", controller: address2, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    Row(
                      children: [
                    ...
                    Row(
                      children: [
                        Expanded(child: TextInput(label: "City", controller: city, onChanged: (newValue) {}, isEditable: true, isReadable: false)),
                        const SizedBox(width: 10,),
                        Expanded(child: TextInput(label: "State", controller: state, onChanged: (newValue) {}, isEditable: true, isReadable: false)),
                      ],
                    ),
                    const SizedBox(height: 20),
                    TextInput(label: "PAN", controller: panController, onChanged: (newValue) {}, isEditable: true, isReadable: false),
                    const SizedBox(height: 20),
                    TextInput(label: "Voter Id", controller: voterIdController, onChanged: (newValue) {}, isEditable: true, isReadable: false),
