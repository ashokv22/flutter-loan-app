...
class SupervisorTable extends StatefulWidget {
  const SupervisorTable({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _SupervisorTableState createState() => _SupervisorTableState();
}

class _SupervisorTableState extends State<SupervisorTable> {
    ...
    return Scaffold(
      body: Container(
        ...
        child: FutureBuilder<List<TaskData>>(
          future: applicationService.fetchTaskData("supervisor"),
